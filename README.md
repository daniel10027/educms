...
- Brancher un stockage objet (S3/R2) pour les médias en production.
- Ajouter un éditeur WYSIWYG (TipTap, Quill) à la place du textarea HTML brut.
- Activer Redis (`REDIS_ENABLED=true`, `REDIS_URL=...`) pour mettre en cache les
